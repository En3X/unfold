<section class="postsSection">
    ...
    <?php
    $sql = "
        select * from post where uid != $user->id
    ";
            ...
            <div class="postCard">
                ...
                <div class="controlsSection">
                    <div class="icongroup">
                        ...
                        <?php
                            if ($user->hasLikedPost($row['id'],$mysqli)) {
                                ?>
                    ...
                    <div class="icongroup">
                    <?php
                            if ($user->hasBookmarkPost($row['id'],$mysqli)) {
                                ?>
                                <ion-icon style="color: #6E66FF" name="bookmark"></ion-icon>
                                <?php
                            }else{
                                ?>
                                    <ion-icon style="color: #000" name="bookmark-outline"></ion-icon>
